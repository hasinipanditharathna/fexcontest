...
class ImageViewScreen extends StatefulWidget {
  ...
  const ImageViewScreen({Key? key, required this.mimeType}) : super(key: key);
...
class _ImageViewScreenState extends State<ImageViewScreen> {
  late Future<List<CatGiftsResponseModel>> gifAlbum;
  ...
  void _firstLoad() async {
    ...
    gifAlbum = fetchGifs(_page, widget.mimeType);
  ...
  void _loadMore() async {
    if (_hasNextPage == true &&
      ...
      _page += 1;
      fetchGifs(_page, widget.mimeType);
        ...
        body: SizedBox(
          child: Center(
            child: FutureBuilder<List<CatGiftsResponseModel>>(
              future: fetchGifs(_page, widget.mimeType),
